    ...
    def _build_prompt(
        ...
        *,
        ...
        return (
            ...
            "information.\n"
            "Answer in the same language as the user's question. Give a useful "
            "learning-oriented explanation, not a one-sentence reply. Include "
            "the main idea, key details, and a short example or practical "
            "implication when the context supports it. Keep the answer focused "
            "and cite context chunks like [1] when useful.\n\n"
            f"Context:\n{context}\n\n"
            f"Question:\n{question}\n\n"
            "Answer:"
        )
